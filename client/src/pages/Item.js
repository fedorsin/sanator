            ...
            <div className='grid lg:grid-cols-3 grid-cols-2 gap-5'>
                ...
                <div>
                    ...
                    <div className='grid max-w-sm w-full mt-4 -ml-3 md:ml-5 grid-rows-2'>
                        <h2 className='md:text-2xl md:pr-5 select-none text-xl font-semibold' key={item.id}>от {item.price} руб.</h2>
                        <div>
                            {isItemInBasket() ? 
                                <button className='button_buy mt-3' onClick={() => addItem(item)}>Добавить в избранное</button>
                                :
                                <h1 className='mt-3 text-lg font-semibold text-indigo-500'>Санаторий уже в избранном</h1>
                            }
                        </div>
                    </div>
                </div>
